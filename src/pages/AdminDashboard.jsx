...
import { ShieldCheck, LogOut, FileText, CheckCircle, AlertTriangle } from 'lucide-react'
  ...
  useEffect(() => {
    async function load() {
      ...
      if (user) {
        ...
        setProfile(prof || { full_name: user.user_metadata?.full_name, role: 'admin' })
      }
    }
    load()
  }, [])
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <p className="text-sm text-slate-600 mt-1 mb-8">
          Verify healthcare entities, monitor priority scoring, and inspect request audit trails
        </p>

        <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 mb-8">
          <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-xs">
            <div className="flex items-center justify-between">
              <span className="text-xs font-semibold text-slate-500 uppercase">Verified Entities</span>
          ...
          <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-xs">
            <div className="flex items-center justify-between">
              <span className="text-xs font-semibold text-slate-500 uppercase">Audit Log Events</span>
          ...
          <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-xs">
            <div className="flex items-center justify-between">
              <span className="text-xs font-semibold text-slate-500 uppercase">Critical Requests</span>
